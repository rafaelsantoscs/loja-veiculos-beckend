...
public class EstabelecimentoCompletoDTO {
    ...
    private List<ResponsavelLegalDTO> responsaveisLegais;
    private List<ResponsavelTecnicoDTO> responsaveisTecnicos;

    // Constructors
    public EstabelecimentoCompletoDTO() {}
    ...
    public String getOutroArea() {
        return outroArea;
    }

    public void setOutroArea(String outroArea) {
        this.outroArea = outroArea;
    }
    ...
    public List<ResponsavelLegalDTO> getResponsaveisLegais() {
        return responsaveisLegais;
    }

    public void setResponsaveisLegais(List<ResponsavelLegalDTO> responsaveisLegais) {
